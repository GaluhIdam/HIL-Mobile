                                                                  ...
                                                                  FutureBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        if (snaphot.data ==
                                                                          ...
                                                                          if (detailTask[0].statusNo == '' ||
                                                                              detailTask[0].statusNo == null) {
                                                                            return DropdownButtonFormField(
                                                                                hint: Text('Please select status'),
                                                                                decoration: InputDecoration(
                                                                                    enabledBorder: OutlineInputBorder(
                                                                            ...
                                                                            return DropdownButtonFormField(
                                                                                ...
                                                                                onChanged: (dynamic newValue) {
                                                                                  setState(() {
                                                                                    detailTask[0].statusNo = newValue!;
                                                                                  });
                                                                                },
                                                                                items: snaphot.data!);
                                                                          }
                                                                  ...
                                                                  FutureBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        if (snapshot.data ==
                                                                            null) {
                                                                          return DropdownButtonFormField(
                                                                              hint: Text('Please select station'),
                                                                              decoration: InputDecoration(
                                                                                  enabledBorder: OutlineInputBorder(
                                                                                    borderSide: const BorderSide(color: Color.fromRGBO(226, 234, 239, 1), width: 2),
                                                                                    borderRadius: BorderRadius.circular(10),
                                                                          ...
                                                                          if (detailTask[0].staClose == 'null' ||
                                                                              detailTask[0].staClose == null) {
                                                                            return DropdownButtonFormField(
                                                                                hint: Text('Please select station'),
                                                                                decoration: InputDecoration(
                                                                                    enabledBorder: OutlineInputBorder(
                                                                                ...
                                                                                onChanged: (dynamic newValue) {
                                                                                  setState(() {
                                                                                    detailTask[0].staClose = newValue;
                                                                                  });
                                                                                },
                                                                                items: snapshot.data!);
                                                                          } else {
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          GestureDetector(
                                                                            ...
                                                                            child:
                                                                                Container(margin: const EdgeInsets.fromLTRB(0, 15, 15, 10), child: const Icon(Icons.close)),
                                                                          )
                                                                        ],
                                                                      ),
                                                                      Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Container(margin: const EdgeInsets.fromLTRB(0, 0, 0, 10), child: const Text('Change Option to')),
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            if (_formKey.currentState!.validate()) {
                                                                              ScaffoldMessenger.of(context).showSnackBar(
                                                                                const SnackBar(duration: Duration(seconds: 1), behavior: SnackBarBehavior.floating, content: Text('Updating data...')),
                                                                              );
                                                                              OptionService.updateOption(detailTask[0].itemId, token, detailTask[0].optionId);
                                                                            }
                                                                          },
                                                                          child:
                                                                              const Text(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                GestureDetector(
                                                                                  ...
                                                                                  child: Container(margin: const EdgeInsets.fromLTRB(0, 15, 15, 10), child: const Icon(Icons.close)),
                                                                                )
                                                                              ],
                                                                            ),
                                                                            Container(
                                                                            ...
                                                                            Container(
                                                                              margin: const EdgeInsets.all(15),
                                                                              child: ElevatedButton(
                                                                                style: ElevatedButton.styleFrom(backgroundColor: const Color.fromRGBO(1, 98, 153, 1), minimumSize: const Size.fromHeight(45), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                                                                                onPressed: () {
                                                                                  if (_formKey.currentState!.validate()) {
                                                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                                                      const SnackBar(duration: Duration(seconds: 1), behavior: SnackBarBehavior.floating, content: Text('Updating data...')),
                                                                                    );
                                                                                    OptionService.updateOption(detailTask[0].itemId, token, detailTask[0].optionId).then((value) {
                                                                                      Navigator.pop(context);
                                                                                      ScaffoldMessenger.of(context).showSnackBar(
                                                                                        SnackBar(
                                                                                            behavior: SnackBarBehavior.floating,
                                                                                      ...
                                                                                      Navigator.pushReplacementNamed(context, TaskDetailsPage.routeName, arguments: {
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  Container(margin: const EdgeInsets.fromLTRB(0, 0, 0, 10), child: const Text('Change Option to')),
                                                                                  detailTask[0].optionId == '' || detailTask[0].optionId == 'null'
                                                                                      ? DropdownButtonFormField(
                                                                                          validator: (value) {
                                                                                            if (value == null) {
                                                                                              return 'Please select option';
