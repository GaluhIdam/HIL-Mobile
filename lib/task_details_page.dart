        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  width: MediaQuery.of(context).size.width / 2.235,
                  child: Column(
          ...
          Container(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                side: BorderSide(width: 1, color: Color.fromRGBO(1, 98, 153, 1)),
              ...
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 15, fontWeight: FontWeight.w600, color: Color.fromRGBO(1, 98, 153, 1)),
              ),
            ),
          ),
        ],
